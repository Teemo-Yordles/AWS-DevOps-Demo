...
-- ---------------------------------------------------------------
DROP TABLE IF EXISTS `rdms_chute`;
CREATE TABLE `rdms_chute` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY uk_rdms_chute_1 ( `chute_code`, `inspire_time`, `expire_time` )
) ENGINE=InnoDB DEFAULT charSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='参考数据管理系统_行李传送带代码表';