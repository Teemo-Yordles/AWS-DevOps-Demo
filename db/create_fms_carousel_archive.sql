...
-- ---------------------------------------------------------------
-- Table structure for flight carousel allocation archive table.
-- ---------------------------------------------------------------
DROP TABLE IF EXISTS `fms_carousel_archive`;
CREATE TABLE `fms_carousel_archive` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_fms_carousel_archive_1` (`flight_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COLLATE=utf8mb4_0900_ai_ci COMMENT='航班行李转盘分配历史表'
