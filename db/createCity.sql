...
-- ---------------------------------------------------------------
DROP TABLE IF EXISTS `rdms_city`;
CREATE TABLE `rdms_city` (
    `id` bigint(20) NOT NULL AUTO_INCREMENT,
    `iata_city_code` char(3) NOT NULL,
    `icao_city_code` char(4),
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY uk_rdms_city_1 ( `iata_city_code`, `inspire_time`, `expire_time` )
) ENGINE=InnoDB DEFAULT charSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='参考数据管理系统_城市表';
