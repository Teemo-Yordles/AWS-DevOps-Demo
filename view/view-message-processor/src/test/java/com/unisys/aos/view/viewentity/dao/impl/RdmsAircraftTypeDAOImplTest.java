...
public class RdmsAircraftTypeDAOImplTest {
    @Autowired
    private RdmsAircraftTypeDAO rdmsAircraftTypeDAO;

    @Test
    public void testGetMapEntryKey() {
        RdmsAircraftType record = new RdmsAircraftType();
        record.setId(Long.valueOf(1234567890L));
        assertThat("1234567890".equals(rdmsAircraftTypeDAO.getMapEntryKey(record))).isTrue();
    }
}