...
public class RdmsRegionCountryAssociationDAOImplTest {
    @Autowired
    private RdmsRegionCountryAssociationDAO rdmsRegionCountryAssociationDAO;
    ...
    public void testGetMapEntryKey() {
        ...
        assertThat("1234567890".equals(rdmsRegionCountryAssociationDAO.getMapEntryKey(record))).isTrue();
    }
}