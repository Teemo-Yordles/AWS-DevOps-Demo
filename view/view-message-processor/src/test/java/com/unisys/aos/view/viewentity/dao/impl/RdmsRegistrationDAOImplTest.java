...
public class RdmsRegistrationDAOImplTest {
    @Autowired
    private RdmsRegistrationDAO rdmsRegistrationDAO;

    @Test
    public void testGetMapEntryKey() {
        RdmsRegistration record = new RdmsRegistration();
        record.setId(Long.valueOf(1234567890L));
        assertThat("1234567890".equals(rdmsRegistrationDAO.getMapEntryKey(record))).isTrue();
    }
}