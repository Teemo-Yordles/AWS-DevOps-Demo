...
public class FmsDelay implements Serializable, AdditionFlightInfo, Comparable<FmsDelay>  {
    ...
    public boolean matchFlightInfoRecord(AdditionFlightInfo info) {
        ...
        if (!(info instanceof FmsDelay)) {
            return false;
        }
        FmsDelay record = (FmsDelay) info;
        // flightid, delay code, start time must be equal to detect match record.
        if (!flightId.equals(record.getFlightId())) {
            return false;
        }
        if (null == delayCode) {
            return null == record.getDelayCode();
        } else {
            if (!delayCode.equals(record.getDelayCode())) {
                return false;
            }
        }
        if (null == startTime) {
            return null == record.getStartTime();
        } else {
            return startTime.equals(record.getStartTime());
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FmsDelay)) return false;
        FmsDelay that = (FmsDelay) o;
        return Objects.equals(flightId, that.flightId) &&
                Objects.equals(delayCode, that.delayCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(flightId, delayCode, startTime, duration, comments);
    }
     ...
     */
    @Override
    public int compareTo(FmsDelay o) {
