...
/**
 * The <b>RdmsAirlineDAO</b> is an interface, which is used to access
 * RdmsAirline data from database.
 *
 * @author Zhang Wenqiang
 * @since 2020/10/21 23:50
 */
public interface RdmsAirlineDAO extends BaseDAO<RdmsAirline> {
    /**
