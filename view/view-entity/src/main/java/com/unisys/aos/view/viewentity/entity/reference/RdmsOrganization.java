...
/**
 * The <b>RdmsOrganization</b> class is a POJO entity that represents the Organization Code
 ...
 */
public class RdmsOrganization implements Serializable {
    ...
    private Long id;
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    private Integer organizationIdentifier;
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public void setOrganizationIdentifier(Integer organizationIdentifier) {
    ...
    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public String getOrganizationCategories() {
        return organizationCategories;
    }

    @Generated("org.mybatis.generator.api.MyBatisGenerator")
    public void setOrganizationCategories(String organizationCategories) {
        this.organizationCategories = organizationCategories == null ? null : organizationCategories.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", organizationIdentifier=").append(organizationIdentifier);
        sb.append(", description=").append(description);
        sb.append(", localDescription=").append(localDescription);
        sb.append(", organizationCategories=").append(organizationCategories);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RdmsOrganization)) return false;
        RdmsOrganization that = (RdmsOrganization) o;
        return Objects.equals(getOrganizationIdentifier(), that.getOrganizationIdentifier()) &&
                Objects.equals(getDescription(), that.getDescription()) &&
                Objects.equals(getLocalDescription(), that.getLocalDescription()) &&
                Objects.equals(getOrganizationCategories(), that.getOrganizationCategories()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getOrganizationIdentifier(), getDescription(), getLocalDescription(), getOrganizationCategories(), getInspireTime(), getExpireTime());
    }
    ...
    public String getIdentity() {
        return organizationIdentifier.toString() + inspireTime + expireTime;
    }
}