...
public class FmsAirbridge implements Serializable, AdditionFlightInfo, Comparable<FmsAirbridge>  {
    ...
    public boolean matchFlightInfoRecord(AdditionFlightInfo info) {
        ...
        if (!(info instanceof FmsAirbridge)) {
            return false;
        }
        FmsAirbridge record = (FmsAirbridge) info;
...
//        }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FmsAirbridge)) return false;
        FmsAirbridge that = (FmsAirbridge) o;
        return Objects.equals(flightId, that.flightId) &&
                Objects.equals(sequenceNumber, that.sequenceNumber) &&
                Objects.equals(airbridgeCode, that.airbridgeCode) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(flightId, sequenceNumber, airbridgeCode, operation, operationTime);
    }
     ...
     */
    @Override
    public int compareTo(FmsAirbridge o) {
