...
public class FmsEntireRoute implements Serializable, AdditionFlightInfo, Comparable<FmsEntireRoute> {
    ...
    public boolean matchFlightInfoRecord(AdditionFlightInfo info) {
        ...
        if (!(info instanceof FmsEntireRoute)) {
            return false;
        }
        FmsEntireRoute route = (FmsEntireRoute) info;
        // flightid, sequence must be equal to detect match record.
        if (!flightId.equals(route.getFlightId())) {
            return false;
        }
        if (null == sequenceNumber) {
            return null == route.getSequenceNumber();
        } else {
            return sequenceNumber.equals(route.getSequenceNumber());
        }
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FmsEntireRoute)) return false;
        FmsEntireRoute that = (FmsEntireRoute) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(flightId, sequenceNumber, airportCode, arrivalTime, departureTime);
    }
     ...
     */
    @Override
    public int compareTo(FmsEntireRoute o) {
