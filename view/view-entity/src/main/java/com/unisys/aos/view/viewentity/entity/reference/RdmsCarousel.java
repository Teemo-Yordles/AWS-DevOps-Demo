...
public class RdmsCarousel implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RdmsCarousel)) return false;
        RdmsCarousel that = (RdmsCarousel) o;
        return Objects.equals(getCarouselCode(), that.getCarouselCode()) &&
                Objects.equals(getDescription(), that.getDescription()) &&
                Objects.equals(getLocalDescription(), that.getLocalDescription()) &&
                Objects.equals(getCarouselCategory(), that.getCarouselCategory()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getCarouselCode(), getDescription(), getLocalDescription(), getCarouselCategory(), getTerminalCode(), getInspireTime(), getExpireTime());
    }
    ...
    public void setCarouselCategory(String carouselCategory) {
        this.carouselCategory = carouselCategory == null ? null : carouselCategory.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", carouselCategory=").append(carouselCategory);
    ...
    public String getIdentity() {
        return carouselCode + inspireTime + expireTime;
    }
}