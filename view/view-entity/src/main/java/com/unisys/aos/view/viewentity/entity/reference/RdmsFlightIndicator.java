...
/**
 * The <b>RdmsFlightIndicator</b> class is a POJO entity that represents flight indicator
 ...
 */
public class RdmsFlightIndicator implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RdmsFlightIndicator)) return false;
        RdmsFlightIndicator that = (RdmsFlightIndicator) o;
        return Objects.equals(getIndicatorCode(), that.getIndicatorCode()) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getIndicatorCode(), getDescription(), getLocalDescription(), getInspireTime(), getExpireTime());
    }
    ...
    public String getIdentity() {
        return indicatorCode + inspireTime + expireTime;
    }
