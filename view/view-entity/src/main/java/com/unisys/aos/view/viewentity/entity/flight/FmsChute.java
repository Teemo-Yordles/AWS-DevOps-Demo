...
public class FmsChute implements Serializable, AdditionFlightInfo, Comparable<FmsChute>  {
    ...
    public boolean matchFlightInfoRecord(AdditionFlightInfo info) {
        ...
        if (!(info instanceof FmsChute)) {
            return false;
        }
        FmsChute record = (FmsChute) info;
    ...
    public void setChuteIndicator(String chuteIndicator) {
        this.chuteIndicator = chuteIndicator == null ? null : chuteIndicator.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", chuteIndicator=").append(chuteIndicator);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FmsChute)) return false;
        FmsChute that = (FmsChute) o;
        return Objects.equals(flightId, that.flightId) &&
                Objects.equals(sequenceNumber, that.sequenceNumber) &&
                Objects.equals(chuteCode, that.chuteCode) &&
                ...
                Objects.equals(chuteCategory, that.chuteCategory) &&
                Objects.equals(chuteIndicator, that.chuteIndicator);
    }

    @Override
    public int hashCode() {
        return Objects.hash(flightId, sequenceNumber, chuteCode, chuteCategory, plannedStartTime, plannedEndTime, actualStartTime, actualEndTime, chuteIndicator);
    }
     ...
     */
    @Override
    public int compareTo(FmsChute o) {
