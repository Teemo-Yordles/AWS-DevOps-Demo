...
/**
 * The <b>RdmsRegion</b> class is a POJO entity that represents the Region Code
 ...
 */
public class RdmsRegion implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RdmsRegion)) return false;
        RdmsRegion that = (RdmsRegion) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getRegionCode(), getDescription(), getLocalDescription(), getInspireTime(), getExpireTime());
    }
    ...
    public String getIdentity() {
        return regionCode + inspireTime + expireTime;
    }
}